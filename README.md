...
GitHub Actions runs the processor daily at **9:00 AM IST (UTC+5:30)**, updates `aws_feed_master.xlsx`, and commits it back to the repo. Streamlit Cloud picks up the change automatically.
