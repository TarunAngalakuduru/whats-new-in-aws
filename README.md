...
## Automation
GitHub Actions runs the processor daily at 6:00 AM UTC, updates `aws_feed_master.xlsx`, and commits it back to the repo. Streamlit Cloud picks up the change automatically.
